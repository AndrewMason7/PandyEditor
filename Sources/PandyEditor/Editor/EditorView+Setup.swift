...
extension EditorView {
    ...
    internal func setup() {
        ...
        let rightPadding: CGFloat = showMinimap ? (Metrics.minimapWidth + Metrics.minimapPadding) : Metrics.defaultPadding
        let topInset: CGFloat = showFileHeader ? Metrics.headerHeight : Metrics.defaultPadding
        textContainerInset = UIEdgeInsets(top: topInset, left: Metrics.gutterWidth, bottom: Metrics.defaultPadding, right: rightPadding)
